...
try 
// {coins/markets?vs_currency=pkr?

  const { data } = await axios.get(`${server}/coins/markets?vs_currency=pkr&order=market_cap_desc&per_page=100&page=1&sparkline=false&locale=en`);
      setCoins(data);
      console.log(data);
      setLoading(false);
} catch (error) {
